...
#Spalten umbenennen
colnames(understat) <- c('Liga', 'Jahr', 'Platzierung', 'Team', 'Spiele', 'Siege', 'Unentschieden', 'Niederlagen', 'Tore', 'conceded', 'Punkte', 'xG', 'xG_diff', 'npxG', 'xGA', 'xGA_diff', 'npxGA', 'npxGD', 'ppda_coef','oppda_coef','deep', 'deep_allowed', 'xpts', 'xpts_diff')
...
## Beste Mannschaft 2014

BlaBla

## Effektivster Spielstil
Wurde 2014 aggressives Pressing belohnt oder waren Teams hauptsächlich durch defensive Stabilität
erfolgreich?
Welche Mannschaften waren besonders ineffizient und welche haben unerwartet oft
getroffen?


## deutsche WM Sieg und Championsleague Titelvon Real Madrid
...
## kurze Betrachtung der verwendeten Werkzeuge
Welche + Warum + Schwächen + Stärken


## kritischer Rückblick
würden Sie mit dem Wissen nach dem Projekt
andere Ansätze vorziehen?

## verworfene Lösungsansätze
gab es Lösungsansätze, die Sie verworfen haben? Wenn ja, beschreiben Sie
diese Ansätze und erläutern Sie die Gründe, warum Sie sie nicht mehr weiter
verfolgt haben!
